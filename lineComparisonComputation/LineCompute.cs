        ...
        public void CompareLength()
        {
            if (this.point[0].Equals(this.point[2]) && this.point[1].Equals(this.point[3]))
            {
                ...
                else
                {
                    ...
                    {
                        if (Math.Abs(this.point1[1]) > Math.Abs(this.point1[3]))
                        {
                    ...
                    {
                        if (Math.Abs(this.point1[0]) > Math.Abs(this.point1[2]))
                        {
                            Console.WriteLine("Line 1 length is Greater");
                        }
                        else
            ...
            else if (this.point[0].Equals(this.point[3]) && this.point[1].Equals(this.point[2]))
            {
                ...
                else
                {
                    ...
                    {
                        if (Math.Abs(this.point1[1]) > Math.Abs(this.point1[2]))
                        {
                            Console.WriteLine("Line 1 length is Greater");
                        }
                        else
                    ...
                    {
                        if (Math.Abs(this.point1[0]) > Math.Abs(this.point1[3]))
                        {
                            Console.WriteLine("Line 1 length is Greater");
                        }
                        else
